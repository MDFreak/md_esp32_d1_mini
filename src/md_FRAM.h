...
#define FRAM_OK               0
#define FRAM_ERR_ADDR         -10

#define FRAM_ADDR_STAT        0x0000
#define FRAM_ADDR_VERS        0x0001  // version 1..254,
#define FRAM_ADDR_DATA_NEXT   0x0002  // pointer next data
#define FRAM_ADDR_DATA_START  0x0010

#define FRAM_STAT_ISINIT      0x01
