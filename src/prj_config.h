  ...
  // --- board
    ...
    #define BOARD   BRD_ESP32_Node_AZ_3V3
  //
  // --- usage
    #if !(BOARD ^ BRD_ESP32_Node_AZ_3V3)
      // --- system
        #define USE_TASKING
      ...
      // --- user interface
        #define USE_DISP
            ...
            #ifdef USE_OLED
                // select I2C device
                #define OLED2 DISP_OLED_130_AZ_3V3
                //#define OLED1 DISP_OLED_091_AZ_3V3
  ...
  // --- specification
    ...
    // user interface
          ...
          #define USE_STATUS
              ...
              #ifdef OLED1
                  #define OLED1_I2C_ADDR  0x3C
                  #define OLED1_I2C_SDA   I2C1_SDA
                  #define OLED1_I2C_SCL   I2C1_SCL
                  #ifdef USE_STATUS
                      #define USE_STATUS1
                    #endif
                #endif
              #ifdef OLED2
                  #define OLED2_I2C_ADDR  0x3C
                  #define OLED2_I2C_SDA   I2C2_SDA
                  #define OLED2_I2C_SCL   I2C2_SCL
                  #ifdef USE_STATUS
                      #define USE_STATUS2
                    #endif
                #endif
